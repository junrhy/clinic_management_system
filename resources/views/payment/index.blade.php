            ...
            <div class="block-header">
                <div class="row">
                    <div class="col-lg-5 col-md-5 col-sm-12">
                        <h2>All Payments <small class="text-muted">View Payments</small></h2>
                    </div>            
                    ...
                    <div class="table-responsive">
                        ...
                        @if($patients->count() > 0)
                          ...
                          <tr>
                            ...
                            <td>
                              <div>
                                <a class="show-payment {{ App\Model\FeatureUser::is_feature_allowed('view_patient_payment', Auth::user()->id) }}" href="{{ route('payment.show',$patient_item->id) }}"><i class="fa fa-file-alt" aria-hidden="true"></i> View</a>
                              </div>
                           </td>
                          </tr>
                          <?php endforeach; ?>
