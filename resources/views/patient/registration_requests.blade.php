            ...
            <div class="block-header">
                <div class="row">
                    <div class="col-lg-7 col-md-7 col-sm-12">
                        <h2>Patient Registration Requests <small class="text-muted">All patients who register from the patient registration form will be under review before it will be added to the patient records.</small></h2>
                    </div>            
                    <div class="col-lg-5 col-md-5 col-sm-12 text-right">
                        <ul class="breadcrumb float-md-right">
                            <li class="breadcrumb-item"><a href="/home"><i class="fa fa-home"></i> {{ Auth::user()->client->name }}</a></li>
                            <li class="breadcrumb-item">Newly Registered Patients</li>
                            <li class="breadcrumb-item active">For Review</li>
                        </ul>
                    </div>
                </div>
            </div>
