            ...
            <div class="block-header">
                <div class="row">
                    <div class="col-lg-5 col-md-5 col-sm-12">
                        <h2>Patients <small class="text-muted">Organize your Patient's Records</small></h2>
                    </div>            
                    <div class="col-lg-7 col-md-7 col-sm-12 text-right">
                        ...
                        <ul class="breadcrumb float-md-right">
                            ...
                            <li class="breadcrumb-item active"><strong style="color: #fff;">Patients</strong></li>
                        </ul>
                    </div>
                </div>
            </div>
...
$(document).ready(function() {
  ...
  $(".remove-user-account").unbind().click(function(){
    ...
    Swal.fire({
      title: 'Are you sure?',
      text: "This action will remove the account of this user? You won't be able to revert this!",
      type: 'warning',
      showCancelButton: true,
      confirmButtonColor: '#3085d6',
      cancelButtonColor: '#d33',
